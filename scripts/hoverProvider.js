    ...
    const hoverProvider = vscode.languages.registerHoverProvider('dash', {
        provideHover(document, position) {
            ...
            const docs = {
                ...
                "for": "Creates a loop with an initializer, condition, and increment expression.\n\nInternally expands to a `let` declaration followed by a `while` loop.\n\n**Syntax:** `for (let declaration; condition; increment) statement`\n\n**Example:** `for (let i = 0; i < 5; i = i + 1) print i;`",
